...
const HeroSection = React.memo(({
    ...
    if (!featuredVideo) {
        return (
            <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#050505] via-indigo-950/20 to-[#050505]">
                <div className="text-center max-w-2xl px-6 space-y-8">
                    ...
                    <motion.div
                        ...
                        className="space-y-4"
                    >
                        <h1 className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-indigo-200 to-purple-300 leading-tight">
    ...
    return (
        <>
            <div className="absolute inset-0 bg-[#050505]">
                ...
                <div
                    className={`absolute inset-0 bg-gradient-to-br from-indigo-900/20 to-purple-900/20 transition-opacity duration-1000 ${isImageLoaded ? 'opacity-0' : 'opacity-100'}`}
                />
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 md:p-12 lg:pl-[300px] pb-20 md:pb-32 flex flex-col justify-end h-full pointer-events-none">
                <div className="max-w-3xl pointer-events-auto animate-fade-in-up">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-4 leading-[0.95] tracking-tight drop-shadow-2xl">
                        ...
                        {featuredVideo?.subtitle && (
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-white font-light">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        <button
                            onClick={() => {
                                if (!userData) {
                                    toast.error('Sign in to add to My List')
