    ...
    return (
        ...
        >
            <div className="flex items-center justify-between mb-6">
                ...
                <Link
                    to="/wire"
                    className="flex items-center gap-2 px-4 py-2 bg-sky-600 hover:bg-sky-500 rounded-lg font-bold text-sm transition-all"
                >
            ...
            {wiresLoading ? (
                ...
                <div className="text-center py-20 bg-zinc-900/30 border border-zinc-800 rounded-2xl">
                    ...
                    <Link to="/wire" className="px-6 py-3 bg-sky-600 hover:bg-sky-500 rounded-xl font-bold transition-all inline-block">
                        Post Wire
                    </Link>
                </div>
            ) : (
