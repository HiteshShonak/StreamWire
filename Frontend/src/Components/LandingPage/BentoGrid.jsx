        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          ...
          <ScrollReveal delay={0.2}>
            <motion.div 
              ...
              <div className="relative z-10 h-full flex flex-col">
                <div className={`w-11 h-11 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center mb-3 sm:mb-4 transition-colors duration-150 shrink-0 ${isStealth ? "bg-green-500/10 text-green-400 group-hover:bg-green-500/15" : "bg-emerald-100 text-emerald-600 group-hover:bg-emerald-200"}`}>
                  <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <h3 className={`text-base sm:text-lg font-bold mb-2 shrink-0 ${isStealth ? "text-white" : "text-zinc-900"}`}>Viral Claim™</h3>
                ...
                <div className={`flex-1 rounded-xl p-3 sm:p-4 mb-3 overflow-y-auto ${isStealth ? "bg-zinc-900/50 border border-zinc-800" : "bg-white border border-emerald-100"}`}>
                  ...
                  <ul className={`space-y-1.5 sm:space-y-2 text-[10px] sm:text-xs ${isStealth ? "text-zinc-400" : "text-zinc-600"}`}>
                    <li className="flex items-start gap-1.5">
                      <span className={`font-bold shrink-0 ${isStealth ? "text-green-400" : "text-emerald-500"}`}>1.</span>
                      <span>Post anonymously in Shadows</span>
                    </li>
                    <li className="flex items-start gap-1.5">
                      <span className={`font-bold shrink-0 ${isStealth ? "text-green-400" : "text-emerald-500"}`}>2.</span>
                      <span>Monitor engagement & virality</span>
                    </li>
                    <li className="flex items-start gap-1.5">
                      <span className={`font-bold shrink-0 ${isStealth ? "text-green-400" : "text-emerald-500"}`}>3.</span>
                      <span>Claim ownership with one tap</span>
                    </li>
                    <li className="flex items-start gap-1.5">
                      <span className={`font-bold shrink-0 ${isStealth ? "text-green-400" : "text-emerald-500"}`}>4.</span>
          ...
          <ScrollReveal delay={0.3}>
            <motion.div 
              ...
              <div className="relative z-10 h-full flex flex-col">
                <div className={`w-11 h-11 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center mb-3 sm:mb-4 transition-all duration-150 shrink-0 ${isStealth ? "bg-red-900/20 text-red-400 group-hover:bg-red-900/30" : "bg-red-100 text-red-600 group-hover:bg-red-200"}`}>
                ...
                <div className={`flex-1 rounded-xl p-3 sm:p-4 mb-3 overflow-y-auto ${isStealth ? "bg-zinc-900/50 border border-zinc-800" : "bg-white border border-red-100"}`}>
                  ...
                  <ul className={`space-y-1.5 sm:space-y-2 text-[10px] sm:text-xs ${isStealth ? "text-zinc-400" : "text-zinc-600"}`}>
                    <li className="flex items-start gap-1.5">
                      <span className={`shrink-0 ${isStealth ? "text-emerald-400" : "text-emerald-500"}`}>•</span>
