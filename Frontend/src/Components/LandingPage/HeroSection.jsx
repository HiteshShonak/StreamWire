...
export const HeroSection = ({ isStealth, setIsStealth }) => {
  return (
    <section className="relative pt-28 sm:pt-44 md:pt-48 lg:pt-52 pb-8 sm:pb-12 md:pb-16 lg:pb-20 max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center z-20">
      ...
      <ScrollReveal>
        <div className="space-y-4 sm:space-y-6 md:space-y-8">
          ...
          <div className="min-h-[140px] sm:h-[200px] flex flex-col justify-center">
          ...
          <div className="min-h-[100px] sm:h-[84px] max-w-lg">
            <AnimatePresence mode="wait">
              <motion.p
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
            <Link to="/home" className="w-full sm:w-auto">
              <motion.button
                ...
                className={`group relative w-full sm:w-[180px] lg:w-[200px] h-[48px] sm:h-[52px] lg:h-[56px] rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg flex items-center justify-center gap-2 overflow-hidden transition-all duration-150 ease-out ${isStealth
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98, y: 0 }}
              transition={{ duration: 0.15, ease: [0.4, 0.0, 0.2, 1] }}
              className={`group relative w-full sm:w-[160px] lg:w-[180px] h-[48px] sm:h-[52px] lg:h-[56px] rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg flex items-center justify-center gap-2 overflow-hidden transition-all duration-150 ease-out ${isStealth
