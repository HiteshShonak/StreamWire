         ...
         <div className="relative z-10 px-4 sm:px-6 lg:pl-72 lg:pr-72 pt-20 sm:pt-24 pb-20">
            <div className="max-w-5xl mx-auto">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                  ...
                  >
                     <div className="bg-zinc-900/40 backdrop-blur-sm border border-zinc-800 rounded-2xl sm:rounded-3xl p-5 sm:p-8 h-full">
                  ...
                  >
                     <div className="bg-zinc-900/40 backdrop-blur-sm border border-zinc-800 rounded-2xl sm:rounded-3xl p-5 sm:p-8">
