...
export default function Support() {
   ...
   return (
      <div className="relative min-h-screen bg-[#050505] text-white">
         ...
         {/* Background Glow */}
         <div className="fixed top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-cyan-500 opacity-5 blur-[120px] pointer-events-none" />
         ...
         <div className="relative z-10 lg:pl-72 lg:pr-72 pt-24 pb-20">
            ...
            <motion.div 
               ...
               animate={{ opacity: 1, y: 0 }}
               className="p-6 rounded-2xl border border-cyan-500/30 bg-gradient-to-r from-cyan-500/10 to-transparent mb-12"
            >
                     ...
                     >
                        ...
                        {openFaq === idx && (
                           <motion.div 
                              ...
                              className="px-6 pb-4"
                           >
                              <p className="text-zinc-400 pl-9">{faq.answer}</p>
                           </motion.div>
                        )}
                     </div>
                  ))}
